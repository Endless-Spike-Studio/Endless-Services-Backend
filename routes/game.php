...
Route::group([
    ...
    Route::group([
        ...
        Route::post('/getGJScores20.php', [LeaderboardController::class, 'index'])->name('score.get');
        ...
        Route::post('/getGJComments21.php', [LevelCommentController::class, 'index'])->name('level.comment.get');
        ...
        Route::post('/getGJLevelScores211.php', [LevelLeaderboardController::class, 'fetch'])->name('level.score.get');
