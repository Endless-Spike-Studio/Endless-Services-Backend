...
return [
	'websocket' => [
		...
		'ws_port' => env('WEBSOCKET_WS_PORT'),
		'wss_port' => env('WEBSOCKET_WSS_PORT'),
		'force_tls' => env('WEBSOCKET_FORCE_TLS', false),
		'enabledTransports' => json_decode(env('WEBSOCKET_ENABLED_TRANSPORTS', '[\'ws\', \'wss\']'), true)
	],
	'endless_proxy' => [
