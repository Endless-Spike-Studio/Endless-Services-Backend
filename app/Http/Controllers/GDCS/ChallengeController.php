...
class ChallengeController extends Controller
{
    public function fetchAll(ChallengeFetchRequest $request): string
    {
        ...
        $challenge = implode(':', [
            Str::random(5),
            $data['uuid'],
            GeometryDashAlgorithm::decode(substr($data['chk'], 5), Keys::CHALLENGES->value),
            $data['udid'],
            $data['accountID'] ?? 0,
        ...
        $challengeString = GeometryDashAlgorithm::encode($challenge, Keys::CHALLENGES->value, sha1: false);
