		...
		if ($count < 3) {
			for ($i = 0; $i < 3 - $count; $i++) {
				try {
					...
					throw new GeometryDashChineseServerException(__('gdcn.game.error.challenge_generate_failed_unexpected_exception'), logContext: [
						'message' => $e->getMessage()
					], gameResponse: Response::GAME_CHALLENGE_GENERATE_FAILED_UNEXPECTED_EXCEPTION->value);
				}
			}
		}
