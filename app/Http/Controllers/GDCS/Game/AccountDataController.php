...
class AccountDataController extends Controller
{
    ...
    public function load(AccountDataLoadRequest $request): string
    {
        ...
        if (empty($content)) {
            throw new GeometryDashChineseServerException(__('gdcn.game.error.account_data_load_failed_not_found'), game_response: Response::GAME_ACCOUNT_DATA_LOAD_FAILED_NOT_FOUND->value);
        }
