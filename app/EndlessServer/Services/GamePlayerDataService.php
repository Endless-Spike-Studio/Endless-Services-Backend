...
{
	public function update(int $playerId, int $stars, int $moons, int $demons, int $diamonds, int $icon_id, int $icon_type, int $coins, int $user_coins, int $cube_id, int $ship_id, int $ball_id, int $bird_id, int $dart_id, int $robot_id, int $glow_id, int $spider_id, int $explosion_id, int $swing_id, int $jetpack_id, int $color1, int $color2, int $color3, int $special)
	{
