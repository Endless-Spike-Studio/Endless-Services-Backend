...
enum Response: int
{
    ...
    public const GAME_ACCOUNT_COMMENT_INDEX_FAILED_EMPTY = Response::GAME_SPECIAL_FAILED_2;
    ...
    public const GAME_ACCOUNT_FRIEND_REQUEST_CREATE_FAILED_NOT_FOUND = Response::FAILED;
